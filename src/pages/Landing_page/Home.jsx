    ...
    <section className=' bg-secondary2 h-[47rem] mt-5 overflow-hidden'>
      <div className='flexing bg-secondary2 items-start space-x-3 '>
        <div className='w-1/2 mx-16 '>
          <h1 className='text-7xl font-bold'>Buy, rent, or sell your property easily</h1>
          <p className='my-4 text-xl font-medium'>A great platform to buy, sell, or even rent your properties without any commisions.</p>
          ...
          <Button text={"Browse Properties"} bg={"bg-primary text-white"} link={'/listings'} />
      </div>
