...
const FeaturesSection = () => {
  return (
    <section className='flex flex-col md:flex-row md:space-x-10 space-y-10 md:space-y-0 mt-10 mx-8 sm:mx-16'>
      <div className='w-full md:w-[45%] border-2 bg-secondary2 border-secondary px-5 rounded-lg py-5 relative flex flex-col items-center'>
      ...
      <div className='grid  sm:grid-cols-2 w-full md:w-[55%] space-x-5'>
        {
            Features.map((item)=>(
